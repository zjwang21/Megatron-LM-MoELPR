...
TARGET_EP_SIZE=4
TARGET_PP_SIZE=1
HF_FORMAT_DIR=/root/work/huangxin/nanda/models/Qwen2.5-3B-Instruct-qwenmoe-${NUM_EXPERTS}exp
...
MEGATRON_FORMAT_DIR=/root/work/huangxin/nanda/models/Qwen2.5-3B-Instruct-qwenmoe-mcore-tpsplit-exp${NUM_EXPERTS}-TP${TARGET_TP_SIZE}PP${TARGET_PP_SIZE}EP${TARGET_EP_SIZE}
