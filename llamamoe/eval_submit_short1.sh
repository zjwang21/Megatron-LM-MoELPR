...
then
    ...
    bash $WORK_DIR/eval/test.sh arc short
    bash $WORK_DIR/eval/test.sh belebele short
    bash $WORK_DIR/eval/test.sh mmlu short
    bash $WORK_DIR/eval/test.sh hellaswag short
    work_wait
fi