...
# args
CHECKPOINT_PATH=/root/work/huangxin/nanda/models/llama3-8b-instruct-qwenmoe-mcore-exp8-TP1PP1EP8
...
if [ -n "${WANDB_API_KEY}" ]; then
    LOGGING_ARGS+=(
        ...
        --wandb-exp-name ${WANDB_NAME:-"llama3_instruct_8exp_top2_tp1_ep8"}
    )
fi
