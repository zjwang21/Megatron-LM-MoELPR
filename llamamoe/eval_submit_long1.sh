...
then
    ...
    bash $WORK_DIR/eval/test.sh arc long
    bash $WORK_DIR/eval/test.sh belebele long
    bash $WORK_DIR/eval/test.sh mmlu long
    bash $WORK_DIR/eval/test.sh hellaswag long
    work_wait
fi