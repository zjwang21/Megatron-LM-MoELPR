...
class Encoder(object):
    ...
    def encode(self, json_line):
        ...
        for input, output in zip([input], [output]):
            input_ids = Encoder.tokenizer._tokenizer(input, add_special_tokens=False)['input_ids']
            output_ids = Encoder.tokenizer._tokenizer(output, add_special_tokens=False)['input_ids']
            sentence_ids = [Encoder.tokenizer._tokenizer.bos_token_id] + input_ids + output_ids + [Encoder.tokenizer.eod]
